...
public class BrowserActivity extends AppCompatActivity {
    ...
    private boolean autofillDone = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String pageUrl) {
                ...
                // Inject Cloudflare-watcher + autofill script after every navigation
    ...
    /**
     * Helper JavaScript:
     * 1. Waits for Cloudflare Turnstile checkbox & ticks it (does NOT bypass — just clicks
     *    the checkbox the same way a human finger would).
     * 2. Once the SuperSaaS login form is visible, fills email + password.
     * 3. Submits the form to the ?view=free endpoint.
     */
    private String buildHelperJs() {
        ...
        return "(function(){\n" +
               ...
               "  // ===== 1. Solve Cloudflare Turnstile checkbox (study of background.js / script.js / manifest.json approach) =====\n" +
               ...
               "        }catch(e){}\n" +
               "      });\n" +
               "      // Sometimes the checkbox is in the parent doc\n" +
               ...
               "\n" +
               "  // ===== 2. Auto-fill SuperSaaS login form & submit with ?view=free =====\n" +
               "  function tryFill(){\n" +
               ...
               "    // Force the action to include ?view=free\n" +
               "    try{\n" +
